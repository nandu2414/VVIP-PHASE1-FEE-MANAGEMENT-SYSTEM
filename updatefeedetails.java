...
public class updatefeedetails extends javax.swing.JFrame {
    ...
    public String updateData(){
        ...
        try{
            Connection con=DBconnection.getConnection();
            PreparedStatement stmt=con.prepareStatement("update fees_details set student_name=?,roll_no=?,payment_mode=?,cheque_no=?,bank_name=?,dd_no=?,course_name=?,gstin=?,total_amount=?,date=?,amount=?,cgst=?,sgst=?,total_in_words=?,remark=?,year1=?,year2=? where reciept_no=?");
            
            
            stmt.setString(1, studentname);
            stmt.setString(2, rollno);
            stmt.setString(3, paymentmode);
            stmt.setString(4, chequeno);
            stmt.setString(5, bankname);
            stmt.setString(6, ddno);
            stmt.setString(7, coursename);
            stmt.setString(8, gstin);
            stmt.setFloat(9, totalamount);
            stmt.setString(10, date);
            stmt.setFloat(11, initialamount);
            stmt.setFloat(12, tax);
            stmt.setFloat(13, gst);
            stmt.setString(14, totalinwords);
            stmt.setString(15, remark);
            stmt.setInt(16,year1);
            stmt.setInt(17,year2);
            stmt.setInt(18, receiptno);
    ...
    public void setRecords(){
        try{
            ...
            ResultSet rs=stmt.executeQuery();
            rs.next();
            txtrno.setText(rs.getString("reciept_no"));
            ...
            txttax.setText (rs.getString("sgst"));
            txtgst.setText(rs.getString("cgst"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Validation()){
            ...
            if(result == "success"){
                JOptionPane.showMessageDialog(this,"Record updateted Successfully");
