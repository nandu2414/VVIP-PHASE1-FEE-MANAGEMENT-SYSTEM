...
public class viewAllRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblalldata.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Receipt No", "Student Name", "Roll No", "Payment Mode", "Corse name", "Total Amount", "Date", "year1", "year2"
            }
        ));
        jScrollPane1.setViewportView(tblalldata);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 770, 550));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 0, 840, 620));
